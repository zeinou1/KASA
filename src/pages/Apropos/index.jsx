      ...
      <main className="main">
        <div className="apropos">
          ...
          <article className="apropos__liste">
            <h2 className="apropos__title">Fiabilité</h2>

            {Viable ? (
              <FontAwesomeIcon
                onClick={() => setViable(!Viable)}
                icon={faChevronDown}
          ...
          <article className="apropos__liste">
            <h2 className="apropos__title"> Respect</h2>
            {Respecte ? (
              <FontAwesomeIcon
                onClick={() => setRespecte(!Respecte)}
                icon={faChevronDown}
                className="apropos__chevron"
              />
            ) : (
          ...
          {/* collapse Récupération des informations page apropos(Services)*/}
          <article className="apropos__liste">
            <h2 className="apropos__title"> Service</h2>

            {ServiceA ? (
              <FontAwesomeIcon
                onClick={() => setServiceA(!ServiceA)}
                icon={faChevronDown}
                className="apropos__chevron"
              />
            ) : (
