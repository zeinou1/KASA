			...
			<div className="Logement">
				...
				<div className="Logement__descrption">
					<h2 className='Logement__descrption_h2'>Description</h2>
						...
						{ Show ? (
										(	<FontAwesomeIcon onClick={() => setShow(!Show)} icon={faChevronDown} className="Logement__equipemen_chevron-Down"/>)
								):
								<FontAwesomeIcon onClick={() => setShow(!Show)} icon={faAngleUp} className="Logement__equipemen_chevron-Up"/>
						}
						{Show && <Desc/>}
			    ...
			    <h2 className='Logement__equipemen_h2'> Equipement</h2>
						...
						{ ShowEquiment ? (
										(	<FontAwesomeIcon onClick={() => setShowEquiment(!ShowEquiment)} icon={faChevronDown} className="Logement__equipemen_chevron-Down"/>)
								):
								<FontAwesomeIcon onClick={() => setShowEquiment(!ShowEquiment)} icon={faAngleUp} className="Logement__equipemen_chevron-Up"/>
						}
